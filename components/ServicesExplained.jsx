...
const ServicesExplained = () => {
  return (
    <div id="services_explained">
        ...
        <Controller>
          <div className="h-[150vh] flex">
            <Scene duration={442} pin={true} enabled={true} offset={400}>
              <div className="bg-[#F88170] w-1/2 h-screen flex justify-center items-center border-r-4 border-black">
                <div className="">
            ...
            <div className="w-1/2 h-screen">
              <div className="bg-[#F7BF09] h-[50vh] flex flex-col justify-around items-center"></div>
              <div className="bg-[#F7BF09] h-[100vh] flex flex-col justify-around items-center">
                <p className="font-semibold hidden md:block sm:text-md le:text-lg text-right le:m-11">
                  all good designs begin with research. before <br /> any
      ...
      <div className="md:hidden bg-[#F88170] py-[6rem]">
        <Controller>
          ...
          <div className="bg-[#F88170]  justify-around items-center mt-[-20.2rem]">
      ...
      <div className="hidden md:block">
        <Controller>
          <div className="h-[150vh] flex">
            <Scene duration={442} pin={true} enabled={true} offset={400}>
              <div className="bg-[#93C2EA] w-1/2 h-screen flex justify-center items-center border-r-4 border-black">
                <div className="">
                  <div className="le:h-[12rem] le:w-[27.5rem] border-4 border-[#1E1E1F] bg-white drop-shadow-[5px_4px_0px_rgb(30,30,31)]">
            ...
            <div className="w-1/2 h-screen">
              <div className="bg-[#FFA6CE] h-[50vh] flex flex-col justify-around items-center"></div>
      ...
      <div className="hidden md:block">
        <Controller>
          <div className="h-[150vh] flex">
            <Scene>
              <div className="w-1/2 h-screen">
                <div className="bg-[#F7BF09] h-[50vh] flex flex-col justify-around items-center border-r-4 border-black"></div>
                <div className="bg-[#F7BF09] h-[100vh] flex flex-col justify-around items-center border-r-4 border-black">
                  <p className="font-semibold hidden md:block sm:text-md le:text-lg text-right le:m-11">
                    you can’t just settle for cookie-cutter verbiage on your
                    website. what is it that your users need? we’ll conduct an
                    seo audit to see where your current website sits in your
                    market.
                    <br />
                    <br />
                    then, we utilize highly effective and successful seo
                    strategies, such as completing keyword research, ensuring
                    you’re on location search pages, and creating a google
                    business profile.
                  </p>
                  <p className="font-semibold text-[0.8rem] xs:text-[0.9rem] md:hidden m-5 text-right">
                    you can’t just settle for cookie-cutter verbiage on your
          ...
          <div className="h-[150vh] flex">
            <Scene>
              <div className="w-1/2 h-screen">
                ...
                <div className="bg-[#F7BF09] h-[100vh] flex flex-col justify-around items-center border-r-4 border-black">
                  <p className="font-semibold hidden md:block sm:text-md le:text-lg text-right le:m-11">
                    57% of Americans won’t recommend a business with poorly
                    designed mobile websites. don’t limit yourself to only
                    desktop users. we specialize in programming mobile
                    responsive websites from ecommerce sites like shopify, to
                    corporate websites, to local shops.
                    <br />
                    <br />
                    we develop custom, modern, cutting edge website designs for
                    any ambitious business. this includes css, html, javascript,
                    various backend solutions and frameworks like react and
                    nextjs.
                  </p>
                  <p className="font-semibold text-[0.8rem] xs:text-[0.9rem] md:hidden m-5 text-right">
                    57% of Americans won’t recommend a business with poorly
        ...
        <Controller>
          <div className="h-[150vh] flex">
            ...
            <div className="w-1/2 h-screen">
              ...
              <div className="bg-[#F7BF09] h-[100vh] flex flex-col justify-around items-center">
                <p className="font-semibold hidden md:block sm:text-md le:text-lg text-right le:m-11">
                  lets face it; advertising and cold-calling just aren’t the
                  move anymore. were living in a new age for getting your
                  business out there: content marketing, digital marketing, and
                  social media marketing.
                  <br />
                  <br />
                  nowadays, you need a good bio, trendy content creation, brand
                  consistency, eye-popping logo, social media ads, you name it.
                  it’s also like you have to be a jack of all trades. or, you
                  can let us handle it.
                </p>
                <p className="font-semibold text-[0.8rem] xs:text-[0.9rem] md:hidden m-5 text-right">
                  lets face it; advertising and cold-calling just aren’t the
                  move anymore. were living in a new age for getting your
            ...
            <div className="w-1/2 h-screen">
              ...
              <div className="bg-[#F7BF09] h-[100vh] flex flex-col justify-around items-center">
                <p className="font-semibold hidden md:block sm:text-md le:text-lg text-right le:m-11">
                  ...
                  accounts, then you’re missing out on 72% of potential
                  customers.
                  <br />
                  <br />
                  we take the confusion out of content creation by managing it
                  for you. this includes video creation, social media
                  copywriting, running ad campaigns, engaging with your user
                  base, and moderaton.
                </p>
                <p className="font-semibold text-[0.8rem] xs:text-[0.9rem] md:hidden m-5 text-right">
                  if you’re not actively updating your business’ social media
