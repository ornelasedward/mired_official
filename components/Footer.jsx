  ...
  return (
    <div className="bg-[#FFF8D9]">
      <div className="max-w-[1240px] m-auto justify-between mt-[6rem] border-b-2 border-[#1E1E1F]">
        <div className="m-auto flex justify-between items-center">
          <div className="sm:ml-2">
            <div className="3xs:w-[6rem] sx: sm:w-[10rem]">
              <Image src={Logo} />
            </div>
      ...
      <div className="max-w-[1240px] m-auto flex justify-between items-center sm:my-4 3xs:p-2">
        ...
        <p className="3xs:w-[17.5rem] sxx:w-[14rem] 2xx:w-[17rem] xxs:w-[19rem] sx:w-[16rem] sr:mr-[-1rem] sm:text-[0.78rem] sm:ml-[-2rem] 3xs:text-[0.34rem] xxs:text-[0.45rem] xs:text-[.55rem] sm:text-[.8rem] sm:w-[23rem]">
