        ...
        <div className="my-[10rem]">
          ...
          <p>
            ...
            <li className="m-2">
              ...
              <Link href="/">
                <b className="cursor-pointer">https://mired.io/</b>
              </Link>
          ...
          <section className="mt-11">
            <h2 className="text-2xl my-5">SUMMARY OF KEY POINTS</h2>
            <p>
              <b>
                ...
                can also click <Link href="#tableOfContents">here</Link> to go
            ...
            <p>
              ...
              depending on how you interact with Mired and the Services, the
              choices you make, and the products and features you use. Click
              here to learn more.
            </p>
            <br />
            <p>
              <b>Do we process any sensitive personal information?</b> When We
            ...
            <p>
              ...
              <span /> We have organizational and technical processes and
            ...
            <p>
              ...
              <span /> Depending on where you are located geographically, the
            ...
            <p>
              ...
              <span /> The easiest way to exercise your rights is by filling out
              our data subject request form available here, or by contacting us.
              We will consider and act upon any request in accordance with
              applicable data protection laws.
            </p>
            <br />
            <p>
              Want to learn more about what Mired does with any information we
          ...
          <section id="Info_collect" className="mt-11">
            <h1 className="text-2xl">1. WHAT INFORMATION DO WE COLLECT?</h1>
            <h2 className="my-3">Personal information you disclose to us</h2>
            <p>
            ...
            <br />
            <h1 className="text-lg">Information automatically collected</h1>
            <br />
            <p>
              <b>In Short:</b>{" "}
              <i>
          ...
          <section className="mt-11">
            <h2 className="text-2xl my-5">7. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
            <p>
            ...
            <a>https://www.edoeb.admin.ch/edoeb/en/home.html</a>
            <br />
            <p>
            ...
            <p>
              ...
              may email us at contactmired@gmail.com.
            </p>
          </section>
          <section className="mt-11">
            <h2 className="text-2xl my-5">
          ...
          <section className="mt-11">
            ...
            <br />
            <p>Mired collects and shares your personal information through:</p>
            <br />
            ...
            <br />
            <p>
              Mired has not sold any personal information to third parties for a
              business or commercial purpose in the preceding twelve (12)
              months. Mired has disclosed the following categories of personal
            ...
            <br />
            <p>
              To exercise these rights, you can contact us or by referring to
          ...
          <section className="mt-11">
            ...
            <p>
              ...
              us at contactmired@gmail.com or by post to:
            </p>
            <br />

            <ul>Mired 25 meadow ln Wilmer, TX 75172 United States</ul>
          </section>
          <section className="mt-11">
            <h2 className="text-2xl my-5">
